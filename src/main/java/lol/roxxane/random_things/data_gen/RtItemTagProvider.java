...
public class RtItemTagProvider extends ItemTagsProvider {
	...
	protected void addTags(@NotNull Provider provider) {
		tag(RtItemTags.BARKED_LOGS).add(
			...
			RtBlocks.DEAD_ORE_LOG.get().asItem()
		);
		tag(RtItemTags.STRIPPED_LOGS).add(
			...
			RtBlocks.STRIPPED_DEAD_ORE_LOG.get().asItem()
		);
		tag(RtItemTags.BARKED_WOODS).add(
			...
			RtBlocks.DEAD_ORE_WOOD.get().asItem()
		);
		tag(RtItemTags.STRIPPED_WOODS).add(
			...
			RtBlocks.STRIPPED_DEAD_ORE_WOOD.get().asItem()
		);
		...
		tag(RtItemTags.INDESTRUCTIBLE).add(Items.DIAMOND_SHOVEL, Items.DIAMOND_PICKAXE, Items.DIAMOND_AXE,
		...
		tag(ItemTags.LOGS).addTags(RtItemTags.DEAD_ORE_LOGS);
	}
}
