...
public class MassOre {
	public static final MassOre[] ORES = new MassOre[]{
		new MassOre("minecraft:coal", Items.COAL, BiomeTags.IS_OVERWORLD)
			.tags(BlockTags.COAL_ORES).xp(0, 2)
			.replace_config(OreFeatures.ORE_COAL, 17)
			.replace_config(OreFeatures.ORE_COAL_BURIED, 17, 0.5f),
		new MassOre("minecraft:iron", Items.RAW_IRON, BiomeTags.IS_OVERWORLD)
		...
		new MassOre("minecraft:copper", Items.RAW_COPPER, BiomeTags.IS_OVERWORLD)
		...
		new MassOre("minecraft:gold", Items.RAW_GOLD, BiomeTags.IS_OVERWORLD)
		...
		new MassOre("minecraft:lapis", Items.LAPIS_LAZULI, BiomeTags.IS_OVERWORLD)
		...
		new MassOre("minecraft:diamond", Items.DIAMOND, BiomeTags.IS_OVERWORLD)
		...
		new MassOre("minecraft:redstone", Items.REDSTONE, BiomeTags.IS_OVERWORLD)
			.tags(BlockTags.REDSTONE_ORES).xp(1, 5).drops(4, 5)
			.replace_config(OreFeatures.ORE_REDSTONE, 8),
		new MassOre("minecraft:emerald", Items.EMERALD, BiomeTags.IS_OVERWORLD)
